...
$(document).ready(function () {
  ...
  function addTicket($container) {
    ...
    if (template) {
      var template = template.replace(/__name__/g, index).replace(/__name__label__/g, 'Billets'); // On crée un objet jquery qui contient ce template
