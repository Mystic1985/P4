...
$(document).ready(function () {
  ...
  var $container = $('div#p4_museumbundle_orders_tickets'); // On définit un compteur unique pour nommer les champs qu'on va ajouter dynamiquement
  ...
  function addTicket($container) {
    var template = $container.attr('data-prototype').replace(/__name__label__/g, 'Billet').replace(/__name__/g, index); // On crée un objet jquery qui contient ce template

    var $prototype = $(template); // On ajoute au prototype un lien pour pouvoir supprimer le billet

    addDeleteLink($prototype); // On ajoute le prototype modifié à la fin de la balise <div>

    $container.append($prototype);
    var enUrl = /en\/museum\/buy$/;
    var urlComplet = document.location.href; // Création du lien sous forme de bouton
  ...
  console.log($("#nbtickets option:selected").val()); // La fonction qui ajoute un lien de suppression d'un billet
